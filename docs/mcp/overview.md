...
1. Perguntar qual cliente voce usa (se nao for obvio do contexto).
2. Pedir sua API key (`agwpp_live_...`).
3. Editar o config file correspondente (Claude Desktop / Code / Cursor / Codex / VS Code).
4. Pedir pra reiniciar o app.
5. Validar com "Liste minhas conexoes WhatsApp via ZenHub MCP".
